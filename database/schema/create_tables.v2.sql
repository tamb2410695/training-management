...
CREATE TABLE IF NOT EXISTS ACCOUNT (
  ...
  CONSTRAINT fk_account_role_id FOREIGN KEY (role_id) REFERENCES ROLE(role_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS USER_ROLE (
  ...
  CONSTRAINT fk_ur_account_id FOREIGN KEY (account_id) REFERENCES ACCOUNT(account_id) ON DELETE CASCADE,
  CONSTRAINT fk_ur_role_id FOREIGN KEY (role_id) REFERENCES ROLE(role_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS ATTENDANCE (
  ...
  CONSTRAINT uq_attendance_session UNIQUE (schedule_id, class_id, student_id),
  CONSTRAINT fk_attendance_staff_id FOREIGN KEY (marked_by_staff_id) REFERENCES STAFF_PROFILE(staff_id),
  CONSTRAINT fk_attendance_class_id FOREIGN KEY (class_id) REFERENCES CLASS(class_id),
