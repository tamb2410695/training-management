const GROUPED_ERRORS = {
  ...
  ACCOUNT: {
    ROLE_NOT_FOUND: { code: "ROLE_NOT_FOUND", message: "Role not found" },
    INVALID_ROLE: { code: "INVALID_ROLE", message: "Invalid role name" },
    ROLE_CODE_EXISTED: {
    ...
    ROLE_ALREADY_ASSIGNED: {
      ...
      message: "This role has already been assigned to the account",
    },
  },
