...
export const DOCUMENT_ROLES = buildEnum({
  ADMIN: {
    label: "Quản trị viên",
    color: "danger",
    order: 1,
...
export const DOCUMENT_ROLE_GROUP = {
  STUDENT: [
    DOCUMENT_ROLES.values.STUDENT,
  ],

  STAFF: [
    DOCUMENT_ROLES.values.ADMIN,
    DOCUMENT_ROLES.values.INSTRUCTOR,
  ],
};
